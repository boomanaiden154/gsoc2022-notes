...
RUN wget --quiet https://storage.googleapis.com/tensorflow/libtensorflow/libtensorflow-gpu-linux-x86_64-1.15.0.tar.gz && \
    mkdir /tmp/tensorflow && \
    tar xfz libtensorflow-gpu-linux-x86_64-1.15.0.tar.gz -C /tmp/tensorflow
